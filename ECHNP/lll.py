# from https://github.com/kionactf/coppersmith
...
fplll_path = "/usr/bin" # /usr/bin, where fplll is installed
flatter_path = '~/flatter/build/bin' # where flatter is installed
